                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div className="p-4 sm:p-6">
                            <div className="space-y-4">
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 rounded-xl border border-gray-200 gap-3">
                                    <div>
                                        <h3 className="font-medium text-gray-900">Default Talk Length</h3>
                                        <p className="text-gray-600 text-sm">15 minutes</p>
                                    </div>
                                    <button className="px-4 py-2 text-blue-600 hover:text-blue-700 font-medium transition-colors text-left sm:text-center">
                                        Customize
                                    </button>
                                </div>
                        ...
                        <div className="p-4 sm:p-6">
                            <div className="bg-red-50 border border-red-200 rounded-xl p-4">
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                    ...
                                    <button className="px-4 py-2 text-red-600 hover:text-red-700 font-medium transition-colors text-left sm:text-center">
                                        Delete
                                    </button>
                                </div>
                            </div>

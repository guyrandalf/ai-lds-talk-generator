  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative">
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-6 lg:px-8 pt-20 pb-16 sm:pt-24 sm:pb-20">
          <div className="text-center">
            {/* Main Heading */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 mb-6">
              Create Meaningful
              <span className="block text-blue-600">LDS Talks</span>
            </h1>
                ...
                <form action="/questionnaire" method="GET" className="space-y-4">
                  <div className="flex flex-col sm:flex-row gap-3">
                    <input
                      ...
                      className="flex-1 px-4 py-4 text-lg border border-gray-300 rounded-xl bg-white text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                    />
                    <button
                      type="submit"
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100">
                  <div className="text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                      ...
                      <Link
                        href="/auth/login"
                        className="inline-flex items-center justify-center px-6 py-3 border border-blue-300 text-base font-medium rounded-xl text-blue-700 bg-white hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200"
                      >
                        Sign In
                      </Link>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Official Church Content</h3>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Personal & Authentic</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Export to Word</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 py-16">
        <div className="max-w-4xl mx-auto text-center px-6 sm:px-6 lg:px-8">
